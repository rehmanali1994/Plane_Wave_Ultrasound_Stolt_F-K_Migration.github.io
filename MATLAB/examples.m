...
%---
% f-k migration
param2.p = 3; % a 3-point sinc interpolator is used
param2.passband = [.3 .7]; % a bandpass filter is used
migRF2 = fkmig(RF2,param2);
% real envelope
...
param3 = param1;
% f-k migration
migRF3 = ezfkmig(RF3,param3.fs,param3.pitch);
% real envelope
